...
- [Paper Mapping](./research/paper-mapping.md)
- [External Strategy Evaluation](./research/external-strategy-evaluation.md)
...
以下内容已不作为当前入口文档，保留在归档目录中用于追溯决策上下文：

- [Roadmap Snapshot 2026-04-07](../archive/docs/roadmap-2026-04-07.md)
- [Eval Platform Evolution Plan](../archive/docs/eval-platform-evolution-plan.md)
- [Boundary Gap Matrix](../archive/docs/boundary-gap-matrix.md)
