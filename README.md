<div align="center">
  ...
  <p><a href="#30-秒-demo">30 秒 Demo</a> · <a href="#快速开始">快速开始</a> · <a href="./docs/research/paper-mapping.md">论文映射</a> · <a href="./docs/guides/reproducibility.md">复现指南</a> · <a href="./docs/guides/open-source-release-checklist.md">开源 Checklist</a></p>
</div>
...
- 它不是只停留在 CLI 脚本层：现在已经有 FastAPI surface、request envelope、最小 worker 路径、SQLite projection store 和内嵌 dashboard shell。
...
- 产品化骨架：已具备 `WorkspaceAuthContext`、queued worker 最小路径、SQLite projection store、内嵌 dashboard shell。
